...
#
CPPFLAGS := 
CFLAGS   := -c -Wall -g -O2 -I/usr/include/libpng15 -DFT_CONFIG_OPTION_USE_PNG -DFT_CONFIG_CONFIG_H="<ftconfig.h>"
...
# Linker flags.
#
LDFLAGS :=  -L/usr/lib -lpng15


# export symbols
#
CCraw_build  := gcc	# native CC of building system
E_BUILD      := .exe	# extension for exexutable on building system
